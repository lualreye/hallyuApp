      ...
      <div class="w-full flex flex-col jutify-center items-center my-4">
        ...
        <div class="w-full flex flex-col justify-start items-center">
          ...
          <div class="w-full flex flex-col justify-center items-start">
            ...
            <input
              type="email"
              class="mt-2 flex justify-center items-center w-full px-3 py-2 bg-aquamarine rounded-lg border border-secondary placeholder-textColor text-base focus:bg-aquamarine outline-none focus:outline-none"
          ...
          <!-- INICIA SESION -->
          <button
            class="mt-6 px-3 py-2 rounded-xl bg-aquamarine text-secondary border border-secondary shadow-lg"
          >
            Iniciar sesión
          </button>
        </div>
