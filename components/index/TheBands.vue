    ...
    <div class="mx-auto max-w-screen-2xl">
      ...
      >
        ...
        >
          <div class="flex justify-center items-end">
            ...
            <p class="ml-2 font-open font-bold text-xl text-textColor">
              por tu
            </p>
          ...
          <div class="flex justify-center items-end">
            ...
            <p
              class="ml-2 font-open font-bold text-xl text-right text-textColor"
            >
              favorita
            </p>
          </div>
      ...
      >
        <div
          ...
          :key="i"
          class="flex justify-center items-center w-1/2 md:w-1/3 lg:w-1/5 mb-8"
        >
...
<script>
import TenthType from "~/components/parenthesis/TenthType.vue";
...
export default {
  ...
  data: () => ({
    bgImage: require("../../static/images/backgrounds/fondo3.png"),
  }),
};
</script>
