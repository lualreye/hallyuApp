<template>
  <div class="max-w-screen-xl mx-auto">
    <div class="py-16 px-4 mx-auto bg-primary bg-cover bg-center" :style="{ backgroundImage: 'url(' + bg + ')'}">
      <h1 class="text-2xl sm:text-3xl md:text-4xl text-hBlack font-open font-bold w-full">
        Términos y condiciones
      </h1>
    </div>
    <div class="py-4 px-2 max-w-4xl mx-auto">
      <!-- INFORMACION GENERAL -->
      <h2 class="text-textColor text-xl md:text-2xl lg:text-3xl font-open font-semibold my-8">
        Información general
      </h2>
      <p class="text-textColor text-base font-open">
        Este sitio web es operado por Yaener Pacheco (Nombre de razón social con nombre comercial Halllyu Store. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Yaener Pacheco (Nombre de razón social con nombre comercial Halllyu Store ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
      </p>
        <br/>
      <p class="text-textColor text-base font-open">
      ...
      <p class="text-textColor text-base font-open">
        ...
        <br/>
      <!-- SECCION 1 -->
      <h3 class="text-textColor text-xl md:text-2xl lg:text-3xl font-open font-semibold my-8">
      ...
      <p class="text-textColor text-base font-open">
        ...
        <br/>
      <p class="text-textColor text-base font-open">
        En ningún caso Yaener Pacheco (Nombre de razón social, nuestros directores, funcionarios, empleados, afiliados, agentes, contratistas, internos, proveedores, prestadores de servicios o licenciantes serán responsables por cualquier daño, pérdida, reclamo, o daños directos, indirectos, incidentales, punitivos, especiales o consecuentes de cualquier tipo, incluyendo, sin limitación, pérdida de beneficios, pérdida de ingresos, pérdida de ahorros, pérdida de datos, costos de reemplazo, o cualquier daño similar, ya sea basado en contrato, agravio (incluyendo negligencia), responsabilidad estricta o de otra manera, como consecuencia del uso de cualquiera de los servicios o productos adquiridos mediante el servicio, o por cualquier otro reclamo relacionado de alguna manera con el uso del servicio o cualquier producto, incluyendo pero no limitado, a cualquier error u omisión en cualquier contenido, o cualquier pérdida o daño de cualquier tipo incurridos como resultados de la utilización del servicio o cualquier contenido (o producto) publicado, transmitido, o que se pongan a disposición a través del servicio, incluso si se avisa de su posibilidad. Debido a que algunos estados o jurisdicciones no permiten la exclusión o la limitación de responsabilidad por daños consecuenciales o incidentales, en tales estados o jurisdicciones, nuestra responsabilidad se limitará en la medida máxima permitida por la ley.
      </p>
        <br/>
      <!-- SECCION 14 -->
      <h3 class="text-textColor text-xl md:text-2xl lg:text-3xl font-open font-semibold my-8">
      ...
      <p class="text-textColor text-base font-open">
        Aceptas indemnizar, defender y mantener indemne Yaener Pacheco (Nombre de razón social y nuestras matrices, subsidiarias, afiliados, socios, funcionarios, directores, agentes, contratistas, concesionarios, proveedores de servicios, subcontratistas, proveedores, internos y empleados, de cualquier reclamo o demanda, incluyendo honorarios razonables de abogados, hechos por cualquier tercero a causa o como resultado de tu incumplimiento de las Condiciones de Servicio o de los documentos que incorporan como referencia, o la violación de cualquier ley o de los derechos de un tercero.
      </p>
        <br/>
      ...
      <p class="text-textColor text-base font-open">
        Disponemos de un plazo para devoluciones de  a partir de la fecha en que la paquetería entregó tu pedido en el domicilio y datos proporcionados al realizar la compra. Debes notificar acerca de la devolución antes de que se cumplan los  a través de alguno de nuestros canales de atención:
      </p>
        <br/>
      <p class="text-textColor text-base font-open">
        - En cualquiera de nuestras tiendas del país, presentando tu factura o recibo electrónico, uno de nuestros asesores de venta te ayudará en el proceso. - Solicitar la devolución dentro del plazo de devolución por correo electrónico.
      </p>
        <br/>
      ...
      <p class="text-textColor text-base font-open">
        ...
        <br/>
      <p class="text-textColor text-base font-open">
        - Estar sin usar, en las mismas condiciones en que lo recibiste y sin manipulación alguna. También debe estar en su embalaje original. - Existen varios tipos de bienes que están exentos de ser devueltos. Productos perecederos tales como alimentos, flores, periódicos o revistas no pueden ser devueltos. Tampoco aceptamos productos que son bienes íntimos o sanitarios, materiales peligrosos, o líquidos o gases inflamables.
        Hay algunas situaciones donde solo se pueden garantizar reembolsos parciales:
        <br/>
        - Cualquier producto que no se encuentre en su condición original, que esté dañado o le falten partes por razones ajenas a nosotros. - Libros, posters revistas con obvios signos de uso. - CD, DVD, álbumes, software, juegos de video, cassettes, o discos de vinilo que hayan sido abiertos.
      </p>
        <br/>
      <p class="text-textColor text-base font-open">
      ...
      <p class="text-textColor text-base font-open">
        Aquí por favor encuentra en lista los productos que no aplican a la política de devolución: - Productos que se hayan aceptado por el administrador, contactar con soporte
      </p>
        <br/>
      ...
      <p class="text-textColor text-base font-open">
        Reembolso del dinero: Dependiendo del medio de pago que hayas utilizado para tu compra, el reembolso se hará a través de una transferencia electrónica o a tu tarjeta de crédito. Los reembolsos parciales se procesarán por medio de transferencia electrónica. Los cambios se despacharán aproximadamente en 3 días hábiles después de recibido el producto en la bodega y aplicarán los mismos tiempos de una entrega regular.
      </p>
        <br/>
      ...
      <p class="text-textColor text-base font-open">
        El Usuario podrá devolver sin ningún costo, cualquier producto que presente defectos de fábrica. Los costos de transporte y los demás que conlleve una devolución por motivos diferentes a defectos de fábrica serán cubiertos por el cliente.
      </p>
        <br/>
      ...
      <p class="text-textColor text-base font-open">
        Preguntas acerca de los Términos de Servicio deben ser enviadas a adm.hallyustoreec@gmail.com.
      </p>
        <br/>
      <p class="text-textColor text-base font-open">
        Última actualización de este documento de términos y condiciones: 11/05/2022.
      </p>
        <br/>
